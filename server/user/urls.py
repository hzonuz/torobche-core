...
from user.views import FavouriteProductView, AddOrRemoveFromFavourites, RecentProductView, SignUp, Login, SignOut, UserView
...
urlpatterns = [
    ...
    path('favourites/<product_id>/v0/', AddOrRemoveFromFavourites.as_view(), name='remove-from-favourites-v0'),
